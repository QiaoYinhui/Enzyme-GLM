...
class GLMTokenizerMixin:
    ...
    def sop_token_id(self) -> Optional[int]:
        """
        `Optional[int]`: Id of the start token in the vocabulary, used when training a save_model with autoregressive blank filling.
        """
    ...
    def eop_token_id(self) -> Optional[int]:
        """
        `Optional[int]`: Id of the end token in the vocabulary, used when training a save_model with autoregressive blank filling.
        """
...
class GLMRobertaTokenizer(RobertaTokenizer, GLMTokenizerMixin):
    ...
    @property
    def gmask_token_id(self) -> int:
        raise NotImplementedError("The save_model doesn't support gMASK")

    @property
    def smask_token_id(self) -> int:
        raise NotImplementedError("The save_model doesn't support sMASK")
...
class GLMChineseTokenizer(PreTrainedTokenizer, GLMTokenizerMixin):
    vocab_files_names = {"vocab_file": "cog-pretrain.save_model"}
    truncation_side: str = "left"
    ...
    def build_inputs_with_special_tokens(
        ...
        """
        Build save_model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
class GLMTokenizer:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *inputs, **kwargs):
        ...
        elif config_tokenizer_class == "GPT2Tokenizer": #add a line
            tokenizer_class = GLMGPT2Tokenizer #add a line
