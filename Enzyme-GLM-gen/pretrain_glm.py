...
def main():
    ...
    while True:
        print('初始化预训练权重！')
        args.load = os.path.join('/home/qyh_vm/GLM_Linux/data/trained_model/pretrain_100w+ESP','130000')
        load_pretrained(model, optimizer, lr_scheduler, args, no_deepspeed=args.no_deepspeed_load)
