...
def prepare_tokenizer(args):
    ...
    # tokenizer_path = r"/mnt/c/Users/lenovo/Desktop/qyh_vm/GLM_Linux/tokenizer/output/protein/BPE_tokenizer/BPE_tokenizer_protein_all_50256size.json"
...
def make_data_loader(dataset, tokenizer, batch_size, num_iters, args, shuffle=False, block_collate=False):
    ...
    print('看一下world_size',world_size)
    print('看一下参数block_collate:',block_collate)
...
def make_loaders(args, tokenizer):
    ...
    data_set_args = {
        ...
        "shengchengfenzi_fin" : args.shengchengfenzi_fin
    }
    ...
    if args.train_data is not None:
        ...
        if data_utils.should_split(split):
            ...
            #print('train1:看这里！！！我希望这里的数据是没有被处理的,确实是这样，这里的train返回的数据是[pad]一行完整的序列[pad]')
    ...
    if train is not None and args.batch_size > 0:
        ...
        #print('train2,这里的train经过处理，已经变成了mask之后的版本,下面将它打印出来看一下')
        '''
        import json
