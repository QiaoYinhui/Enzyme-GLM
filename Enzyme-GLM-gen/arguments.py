...
def add_training_args(parser):
    ...
    group.add_argument('--summary-dir', type=str, default="/home/qyh_vm/GLM_Linux/save/output", help="The directory to store the summary")
...
def add_finetune_config_args(parser):
    ...
    group.add_argument('--shengchengfenzi_fin', action='store_true')
    return parser
